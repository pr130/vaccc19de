...
test_that("Getting cumulative data works", {
  ...
  expect_equal(colnames(cumulative), c("ts_datenstand", "ts_download", "bundesland", "bundesland_iso", "RS", "impfungen_kumulativ", "differenz_zum_vortag", "indikation_nach_alter", "berufliche_indikation", "medizinische_indikation", "pflegeheim_bewohner_in", "gesamt_kumulativ", "gesamt_differenz_zum_vortag", "notes"))
