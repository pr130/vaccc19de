...
test_that("Getting cumulative data works", {
  withr::with_file("tests/testthat/impfquotenmonitoring_kumulativ.xlsx", {
    ...
    expect_equal(colnames(cumulative), c("ts_datenstand", "ts_download", "bundesland", "bundesland_iso", "impfungen_kumulativ", "differenz_zum_vortag", "indikation_nach_alter", "berufliche_indikation", "medizinische_indikation", "pflegeheim_bewohner_in"))
