...
test_that("Bundesland data cleaning works", {
  ...
  expect_equal(colnames(cleaned), c("bundesland", "bundesland_iso", "RS", "impfungen_kumulativ", "differenz_zum_vortag", "indikation_nach_alter", "berufliche_indikation", "medizinische_indikation", "pflegeheim_bewohner_in", "notes"))
